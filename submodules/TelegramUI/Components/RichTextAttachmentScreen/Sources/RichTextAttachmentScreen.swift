...
public class RichTextAttachmentScreen: ViewControllerComponentContainer, AttachmentContainable {
    ...
    public init(
        ...
        self.navigationItem.setRightBarButton(UIBarButtonItem(customView: UIView()), animated: false)

        if let navigationBar = self.navigationBar {
            overNavigationContainer.autoresizingMask = [.flexibleWidth, .flexibleHeight]
            overNavigationContainer.frame = navigationBar.bounds
            navigationBar.view.addSubview(overNavigationContainer)
        }
